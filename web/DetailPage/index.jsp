...
<div class="container item-container">
    <% try {
        ...
        <div class="item-detail">
            ...
            <div class="item-info">
                ...
                <div class="row mb-4 h5">
                    ...
                    <div class="col-md-8"><%=rs.getDate(7)%></div>
                </div>
                <div class="row mb-4 h5">
                ...
                <div class="row ml-3 btn-wrapper">
                    <div class="col button bid" data-bs-toggle="modal"
                         data-bs-target="#bid-modal">입찰하기</div>
                    <div class="col button quick" data-bs-toggle="modal"
                         data-bs-target="#quick-modal">즉시구매하기</div>
                    <div class="col button report" data-bs-toggle="modal"
                         data-bs-target="#report-modal">신고하기</div>
                </div>
            </div>
        </div>
        <div class="item-description mb-5">
            <div class="h3 fw-bold mb-3">상세 정보</div>
            <div class="h5"><%=rs.getString(8)%></div>
        </div>
        <div class="modal fade" id="bid-modal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="quick-modal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="h5 fw-bold text-danger">즉시 구매가: 1000원</div>
                    </div>
                    <div class="modal-footer row justify-content-center">
                        <button type="button" class="col-md-3 btn btn-primary" data-bs-dismiss="modal">예</button>
                        <button type="button" class="col-md-3 btn btn-secondary" data-bs-dismiss="modal">아니오</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="report-modal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer row justify-content-center">
                        <button type="button" class="col-md-3 btn btn-primary" data-bs-dismiss="modal">신고하기</button>
                        <button type="button" class="col-md-3 btn btn-secondary" data-bs-dismiss="modal">취소</button>
                    </div>
                </div>
            </div>
