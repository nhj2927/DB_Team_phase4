                ...
                <div class="MyPageBody_content">
                    <div class="cardBox">
                        <%
                            ...
                            sql = "select * from(select rownum as num, a.* from (select b_id, price, create_date, u_id, it_id from bid b WHERE b.u_id = ? ORDER BY b.create_date DESC) a) where num BETWEEN 1 and 3 \n";
